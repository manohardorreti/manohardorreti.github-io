...
void init_UART0 (void)
{
	...
	LPC_UART0 ->FCR = (MULVAL<<4) | DIVADDVAL;
...
int main(void)
{
    ...
    I2C0_Start();
    I2C0_Write(EEPROM_ADDR << 1);
    I2C0_Write(0x00);          // EEPROM memory address
    I2C0_Write(0x55);          // Data
    I2C0_Stop();

}
void I2C0_Init(void)
{
    LPC_SC->PCONP |= (1 << 7);          // Power ON I2C0

    LPC_PINCON->PINSEL1 |= (1 << 22);   // P0.27 SDA
    LPC_PINCON->PINSEL1 |= (1 << 24);   // P0.28 SCL

    LPC_I2C0->I2SCLH = 60;               // ~100kHz
    LPC_I2C0->I2SCLL = 60;
...
void I2C0_Start(void)
{
    LPC_I2C0->I2CONSET = (1 << 5);       // STA
    LPC_I2C0->I2CONCLR = (1 << 5);       // Clear STA.
